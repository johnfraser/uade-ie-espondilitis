...
/*
	...
	public static final int MainFrame.alto_controles = 20;
	public static final int ancho_controles = 500;
	public static final int MainFrame.padding_controles = 50;
	public static final int padding_radio = 250;

	public static final int MainFrame.APP_WINDOW_X = 640;
...
*/
	...
	DefaultComboBoxModel defaultComboBoxModel_cmb_diagnosticos_anteriores;
	...
	protected JButton btBuscarPaciente;
	...
	protected static JOptionPane jOptionPane;
		...
		public DatosPaciente (MainFrame frame) {
			...
			//Titulo
			lbl_titulo = new JLabel("Para comenzar complete los siguientes datos del paciente");
			...
			//lbl_titulo.setBounds(MainFrame.APP_WINDOW_X/2 - w/2,current_y,MainFrame.APP_WINDOW_X / 2 - MainFrame.padding_controles,MainFrame.alto_controles);
			...
			lbl_paciente_nuevo.setBounds(current_x,current_y,MainFrame.APP_WINDOW_X / 2 - MainFrame.padding_controles, MainFrame.alto_controles);
			...
			rdb_paciente_nuevo_no.setBounds(MainFrame.APP_WINDOW_X / 2,current_y, 150 - MainFrame.padding_controles, MainFrame.alto_controles);
		    add(rdb_paciente_nuevo_no);
		    
		    rdb_paciente_nuevo_si = new JRadioButton("Sí");
		    rdb_paciente_nuevo_si.addActionListener(this);
		    rdb_paciente_nuevo_si.setBounds(MainFrame.APP_WINDOW_X / 2 + 150 , current_y,MainFrame.APP_WINDOW_X / 2 - MainFrame.padding_controles, MainFrame.alto_controles);
		    ...
		    lbl_dni_existente.setBounds(current_x,current_y,MainFrame.APP_WINDOW_X / 2 - MainFrame.padding_controles, MainFrame.alto_controles);
		    add(lbl_dni_existente); //, gridBagConstraints);
		    tld_dni_existente = new JTextField ();
		    tld_dni_existente.setBounds(MainFrame.APP_WINDOW_X / 2,current_y,MainFrame.APP_WINDOW_X / 5 - MainFrame.padding_controles , MainFrame.alto_controles);
		    tld_dni_existente.setHorizontalAlignment(SwingConstants.RIGHT);
		    add(tld_dni_existente); //, gridBagConstraints);
		    current_y = current_y + MainFrame.alto_controles *2;
		    btBuscarPaciente = new JButton("Buscar Paciente");
		    btBuscarPaciente.addActionListener(this);
		    btBuscarPaciente.setBounds(MainFrame.APP_WINDOW_X / 2 - 100 ,current_y, MainFrame.APP_WINDOW_X / 2 - MainFrame.padding_controles - 100 , MainFrame.alto_controles);
			add(btBuscarPaciente);
			...
			lbl_paciente_datos.setBounds(current_x,current_y,MainFrame.APP_WINDOW_X / 2 - MainFrame.padding_controles,MainFrame.alto_controles);
			...
			tld_nombre.setBounds(MainFrame.APP_WINDOW_X / 2,current_y,MainFrame.APP_WINDOW_X / 2 - MainFrame.padding_controles, MainFrame.alto_controles);
			...
			tld_apellido.setBounds(MainFrame.APP_WINDOW_X / 2,current_y,MainFrame.APP_WINDOW_X / 2 - MainFrame.padding_controles, MainFrame.alto_controles);
			add(tld_apellido); //, gridBagConstraints);
			
			//DNI
			current_y = current_y + MainFrame.alto_controles;
			lbl_dni = new JLabel("DNI:");
			lbl_dni.setBounds(current_x,current_y,MainFrame.APP_WINDOW_X / 2 - MainFrame.padding_controles, MainFrame.alto_controles);
			add(lbl_dni); //, gridBagConstraints);
			tld_dni = new JTextField ();
			tld_dni.setHorizontalAlignment(SwingConstants.RIGHT);
			tld_dni.setBounds(MainFrame.APP_WINDOW_X / 2,current_y,MainFrame.APP_WINDOW_X / 5 - MainFrame.padding_controles, MainFrame.alto_controles);
			add(tld_dni); //, gridBagConstraints);
			
			//Edad
			current_y = current_y + MainFrame.alto_controles;
			lbl_edad = new JLabel("Edad:");
			lbl_edad.setBounds(current_x,current_y,MainFrame.APP_WINDOW_X / 2 - MainFrame.padding_controles, MainFrame.alto_controles);
			add(lbl_edad); //, gridBagConstraints);
			tld_edad = new JTextField ();
			tld_edad.setHorizontalAlignment(SwingConstants.RIGHT);
			tld_edad.setBounds(MainFrame.APP_WINDOW_X / 2,current_y,MainFrame.APP_WINDOW_X / 5 - MainFrame.padding_controles, MainFrame.alto_controles);
			...
			lbl_sexo.setBounds(current_x,current_y,MainFrame.APP_WINDOW_X / 2 - MainFrame.padding_controles, MainFrame.alto_controles);
			add(lbl_sexo); //, gridBagConstraints);
			
		    rdbMasculino = new JRadioButton("Masculino");
		    rdbMasculino.addActionListener(this);
		    rdbMasculino.setSelected(true);
		    rdbMasculino.setBounds(MainFrame.APP_WINDOW_X / 2,current_y, 150 - MainFrame.padding_controles, MainFrame.alto_controles);
		    add(rdbMasculino);
		    
		    rdbFemenino = new JRadioButton("Femenino");
		    rdbFemenino.addActionListener(this);
		    rdbFemenino.setBounds(MainFrame.APP_WINDOW_X / 2 + 150 , current_y,MainFrame.APP_WINDOW_X / 2 - MainFrame.padding_controles, MainFrame.alto_controles);
		    add(rdbFemenino);
		   ...
		   /* 
			...
			btGuardar.setBounds(MainFrame.APP_WINDOW_X / 2 - ( 150 / 2) ,current_y, 150 , MainFrame.alto_controles);
			add(btGuardar);
	*/
		    current_y = current_y + MainFrame.alto_controles * 2;
			...
			//btSiguiente.setBounds(MainFrame.APP_WINDOW_X / 2 - ( 150 / 2) ,current_y, 150 , MainFrame.alto_controles);
			//btSiguiente.setBounds(MainFrame.APP_WINDOW_X / 2 , MainFrame.APP_WINDOW_Y - MainFrame.alto_controles * 5 , 150 , MainFrame.alto_controles);
		...
		private void cargarDiagnosticos_anteriores() {
					...
					defaultComboBoxModel_cmb_diagnosticos_anteriores = new DefaultComboBoxModel();
					...
					*/
					...
					cmb_diagnosticos_anteriores.setBounds(MainFrame.APP_WINDOW_X / 2,current_y, MainFrame.APP_WINDOW_X / 2 - MainFrame.padding_controles , MainFrame.alto_controles);
				    ...
				    bt_diagnosticos_anteriores.setBounds(MainFrame.APP_WINDOW_X / 2 - 100 ,current_y, MainFrame.APP_WINDOW_X / 2 - MainFrame.padding_controles - 100 , MainFrame.alto_controles);
		...
		*/
	    ...
	    private static void createAndShowGUI() {
	        ...
	        frame.setSize(MainFrame.APP_WINDOW_X, APP_WINDOW_Y);		
	   	    ...
	   	    frame.setPreferredSize(new Dimension(MainFrame.APP_WINDOW_X,APP_WINDOW_Y));
		...
		public void actionPerformed(ActionEvent arg0) {
			...
			if ( arg0.getSource() == btBuscarPaciente ) {
				...
				if ( ! tempDni.isEmpty() ) {
					...
					if ( MainFrame.validarTextoNumerico(tempDni)  ) {
						...
						String strError="El DNI del paciente no es válido";
					...
					String strError="Falta ingresar el DNI del paciente";
					jOptionPane.setMessageType(JOptionPane.ERROR_MESSAGE);
					jOptionPane.showMessageDialog(frame, strError, "Error", JOptionPane.ERROR_MESSAGE );
				}
		...
		private void btBuscarPaciente() {
			...
			if ( paciente != null) {
				...
				String strError="El paciente no existe";
				jOptionPane.setMessageType(JOptionPane.WARNING_MESSAGE);
				jOptionPane.showMessageDialog(frame, strError, "Paciente no existe", JOptionPane.ERROR_MESSAGE );
			}
		...
		private void bt_diagnosticos_anteriores() {
			...
			if (cmb_diagnosticos_anteriores.isEnabled()) {
				if (cmb_diagnosticos_anteriores.getItemCount() > 0) {
					...
					frame.MostrarResultadosAnteriores(this, c);
...
//			btGuardar.setEnabled(true);
			btBuscarPaciente.setEnabled(false);
			...
			lbl_diagnosticos_anteriores.setEnabled(false);
			cmb_diagnosticos_anteriores.setEnabled(false);
...
//			btGuardar.setEnabled(false);
			btBuscarPaciente.setEnabled(true);
			...
			lbl_diagnosticos_anteriores.setEnabled(true);
			cmb_diagnosticos_anteriores.setEnabled(false);
			cmb_diagnosticos_anteriores.removeAllItems();;
			bt_diagnosticos_anteriores.setEnabled(false);
		}
		...
		public boolean validar() {
			...
			if ( rdb_paciente_nuevo_no.isSelected() ) {
				
				if (tld_dni_existente.getText().isEmpty()) {
					strError = "Falta completar el DNI del paciente";
				    resultado = false;
				}
				
			}
			
			if (resultado && this.tld_nombre.getText().isEmpty()) {
				strError = "Falta completar el campo 'nombre'";
			    resultado = false;
			}
			
			if (resultado && this.tld_apellido.getText().isEmpty()) {
				strError = "Falta completar el campo 'apellido'";
				resultado = false;
			}
			if (resultado && this.tld_dni.getText().isEmpty()) {
				strError = "Falta completar el campo 'DNI'";
				resultado = false;
			}
					
			if ( resultado && this.tld_edad.getText().isEmpty()) {
				strError = "Falta completar el campo 'edad'";
				resultado = false;
			}
			
			if ( resultado && !MainFrame.validarTextoNumerico( this.tld_dni.getText() )) {
				strError = "Dato no numérico en el campo 'DNI'";
				resultado = false;
			}
			
			if ( resultado && !MainFrame.validarTextoNumerico( this.tld_edad.getText() )) {
